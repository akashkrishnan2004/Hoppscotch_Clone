...
//       headers: "",
//       body: "",
//       bearerToken: "", // New field for the token
//       response: null,
//     },
//   ]);
//   const [activeFormId, setActiveFormId] = useState(1);
...
//       headers: "",
//       body: "",
//       bearerToken: "", // Add token field to new form
//       response: null,
//     };
//     setForms([...forms, newForm]);
//     setActiveFormId(newForm.id);
...
//                     onChange={(e) =>
//                       handleInputChange(form.id, "bearerToken", e.target.value)
//                     }
//                   />
//                 </div>
  ...
  const [forms, setForms] = useState([
    {
      ...
      headers: "",
      body: "",
      bearerToken: "", // Field for the token
      showBearerTokenInput: false, // Toggle for showing token input
      response: null,
    },
  ]);
  const [activeFormId, setActiveFormId] = useState(1);
